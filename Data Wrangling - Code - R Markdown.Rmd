---
title: "Project: Data Wrangling: Basic Data Manipulation"
...
```{r}
refine <- read_csv("C:/Users/T/Desktop/RStudio Projects/Data Wrangling/refine.csv")
View(refine)
...
Clean up the 'company' column so all of the misspellings of the brand names are standardized. Transform the values in the column to be: philips, akzo, van houten and unilever (all lowercase).
...
5.1: Add four binary (1 or 0) columns for company: company_philips, company_akzo, company_van_houten and company_unilever.
...
5.2:  Add four binary (1 or 0) columns for product category: product_smartphone, product_tv, product_laptop and product_tablet.
